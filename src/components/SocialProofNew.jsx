...
/**
 * SocialProof - "Device Frame with Purple Glow"
 *
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
            Auditable Proof of Stability.
          </h2>
          <p className="text-lg text-slate-400">
            Trace every dollar to the token. Real-time drift detection, cost
            attribution, and failover status—the ROI dashboard your CFO will
            love.
          </p>
        </Motion.div>
